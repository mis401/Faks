...
namespace Belman_Ford
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Funkcija za shortest path ima parametar bool (default false) za printovanje najkrace putanje");
            DynamicGraph G;
            Random r = new Random();
            ...
            for (int N = 100; N <= 100000; N = N * 10)
            {
                ...
                sw.Restart();
                for (int i = 0; i< 10; i++)
                    shortestPath = G.ShortestPathBetweenTwoNodes(G.Nodes.ElementAt(r.Next(N)).Key, G.Nodes.ElementAt(r.Next(N)).Key);
                sw.Stop();
        ...
        public static DynamicGraph GeneratePrimer()
        {
            ...
            G.InsertEdge(G.Nodes.ElementAt(0).Key, G.Nodes.ElementAt(1).Key, 5);
            G.InsertEdge(G.Nodes.ElementAt(0).Key, G.Nodes.ElementAt(4).Key, 9);
            G.InsertEdge(G.Nodes.ElementAt(0).Key, G.Nodes.ElementAt(7).Key, 8);
            G.InsertEdge(G.Nodes.ElementAt(1).Key, G.Nodes.ElementAt(2).Key, 12);
            G.InsertEdge(G.Nodes.ElementAt(1).Key, G.Nodes.ElementAt(3).Key, 15);
            G.InsertEdge(G.Nodes.ElementAt(1).Key, G.Nodes.ElementAt(7).Key, 4);
            G.InsertEdge(G.Nodes.ElementAt(2).Key, G.Nodes.ElementAt(3).Key, 3);
            G.InsertEdge(G.Nodes.ElementAt(2).Key, G.Nodes.ElementAt(7).Key, 7);
            G.InsertEdge(G.Nodes.ElementAt(2).Key, G.Nodes.ElementAt(5).Key, 1);
            G.InsertEdge(G.Nodes.ElementAt(2).Key, G.Nodes.ElementAt(6).Key, 11);
            G.InsertEdge(G.Nodes.ElementAt(3).Key, G.Nodes.ElementAt(6).Key, 9);
            G.InsertEdge(G.Nodes.ElementAt(4).Key, G.Nodes.ElementAt(6).Key, 20);
            G.InsertEdge(G.Nodes.ElementAt(4).Key, G.Nodes.ElementAt(7).Key, 5);
            G.InsertEdge(G.Nodes.ElementAt(5).Key, G.Nodes.ElementAt(6).Key, 13);
            G.InsertEdge(G.Nodes.ElementAt(5).Key, G.Nodes.ElementAt(7).Key, 6);
